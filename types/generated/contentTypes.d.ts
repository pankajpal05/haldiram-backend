...
export interface ApiFooterNoteFooterNote extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'footer-notes';
    singularName: 'footer-note';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer-note.footer-note'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tag: Schema.Attribute.Component<'title.title', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    addressInfo: Schema.Attribute.Component<'footer.footer', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerInfo: Schema.Attribute.Component<'footer-info.footer-info', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    achievementSection: Schema.Attribute.Component<
      'experience-component.experience-component',
      false
    >;
    brandSection: Schema.Attribute.Component<'teaser.teaser', true>;
    carrersSection: Schema.Attribute.Component<
      'carrers-component.carrers-component',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroBanner: Schema.Attribute.Component<'video-teaser.video-teaser', true>;
    latestSection: Schema.Attribute.Component<
